...
export const educationData = [
  {
    ...
    degreeEn: "Informatics Engineering (Bachelor's Degree)",
    year: "2022 - 2026",
    location: "Karawang, Indonesia 🇮🇩",
...
export const achievementsData = [
  {
    ...
    titleEn: "Alibaba Cloud Certified Associate",
  ...
  },
  {
    ...
    titleEn: "Digital Entrepreneurship Certificate",
    issuer: "Digitalent",
    date: "Agustus 2023",
    dateEn: "August 2023",
  ...
  },
  {
    ...
    titleEn: "Cyber Security Seminar",
  ...
  },
  {
    ...
    titleEn: "Certificate Next Generation ECS and OSS",
  ...
  },
  {
    ...
    titleEn: "Secure and Fast - Alibaba Cloud Elastic Compute Service",
    issuer: "Alibaba Cloud",
    date: "2025 - 2026",
...
export const projectsData = [
  {
    ...
    titleEn: "myportfolio-shrlmaulidi V2",
    desc: "Personal website & portfolio, built from scratch using React JS, dan Tailwind CSS. Menampilkan profil, keahlian, dan portofolio secara interaktif.",
    descEn: "Personal website & portfolio, built from scratch using React JS and Tailwind CSS. Displays profile, skills, and portfolio interactively.", // 👈 Tambahan EN
    image: "/proyek/portfolio.png", 
  ...
  },
  {
    ...
    descEn: "CilotoTrack is a web-based application used to monitor, manage, and organize employee tasks centrally. This website helps the company distribute tasks, monitor work progress in real-time, and improve productivity and coordination between teams with a modern and user-friendly interface.",
  ...
  },
  {
    ...
    titleEn: "Sibas (Waste Bank Reporting System)",
    ...
    descEn: "Sibas is a waste bank reporting system website designed to make it easier for the community to report waste that is ready to be collected and transported.",
  ...
  },
  {
    ...
    titleEn: "My Portfolio V1",
    desc: "Personal website & portfolio, built from scratch using HTML, dan Tailwind CSS. Menampilkan profil, keahlian, dan portofolio secara interaktif.",
    descEn: "Personal website & portfolio, built from scratch using HTML and Tailwind CSS. Displays profile, skills, and portfolio interactively.",
  ...
  },
  {
    ...
    titleEn: "High School Student Attendance System",
    desc: "Sistem absensi siswa berbasis lokasi (GPS) dan foto selfie untuk SMAN 3 Cikampek.",
    descEn: "Location-based student attendance system (GPS) with selfie verification for SMAN 3 Cikampek.",
  ...
  },
  {
    ...
    titleEn: "Company Profile PT Aztara Indo",
    desc: "Website Company Profile PT Aztara Indo Contraction.",
    descEn: "Company Profile Website for PT Aztara Indo Construction.",
  ...
  },
  {
    ...
    titleEn: "Personal Branding Logo Design",
    ...
    descEn: "A collection of logo designs and visual identities I created for personal branding and clients. Emphasizing minimalist and modern concepts.",
    images: [
      "/proyek/logo1.png",
      "/proyek/logo2.png",
      "/proyek/logo3.png",
...
export const socialMediaData = [
  {
    ...
    descEn: 'Contact me via email for inquiries or collaborations.',
    btnText: 'Pergi ke Gmail',
    btnTextEn: 'Go to Gmail',
    icon: 'Gmail',
  ...
  },
  {
    ...
    titleEn: 'Follow My Journey',
    desc: 'Ikuti perjalanan kreatif saya.',
    descEn: 'Follow my creative journey.',
    btnText: 'Pergi ke Instagram',
    btnTextEn: 'Go to Instagram',
    icon: 'Instagram',
  ...
  },
  {
    ...
    descEn: 'Connect with me professionally.',
    btnText: 'Pergi ke Linkedin',
    btnTextEn: 'Go to LinkedIn',
    icon: 'LinkedIn',
  ...
  },
  {
    ...
    titleEn: 'Join the Fun',
    desc: 'Tonton konten yang seru dan menarik.',
    descEn: 'Watch fun and engaging content.',
    btnText: 'Pergi ke Tiktok',
    btnTextEn: 'Go to TikTok',
    icon: 'TikTok',
  ...
  },
  {
    id: 5,
    title: 'Jelajahi Kode',
    titleEn: 'Explore Code',
    desc: 'Lihat karya open-source saya.',
    descEn: 'Check out my open-source work.',
...
export const dashboardData = {
  ...
  availability: {
    isAvailable: true,
    status: "Open to Work",
    statusEn: "Open to Work",
    description: "Siap untuk berkontribusi pada proyek inovatif atau posisi Full-time.",
    descriptionEn: "Ready to contribute to innovative projects or Full-time positions.",
    link: "/contact" 
  },
...
export const galleryPhotos = [
  ...
  },
  {
    ...
    captionEn: "Late Night Coding Setup 🌙"
  },
  {
    id: 3,
    ...
    captionEn: "My Personal Branding Logo"
  },
  {
    id: 4,
    ...
    captionEn: "A brief healing trip to Nature 🌲"
  },
  {
    id: 5,
    ...
    captionEn: "Passed React Developer Certification"
  },
  {
    id: 6,
    ...
    captionEn: "Writing Laravel Backend Code"
  },
];