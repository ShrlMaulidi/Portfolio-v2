  ...
  return (
    <>
      ...
      <aside className={`
            ...
            /* DESKTOP: 
               - Sticky top-4: Menempel dengan jarak 1rem dari atas.
               - max-h: Tinggi maksimal menyesuaikan layar dikurangi margin.
               - overflow-y-auto: Bisa di-scroll JIKA layar laptop pendek/konten kepotong.
               - scrollbar-hidden: Menyembunyikan batang scroll agar tetap rapi.
            */
            md:translate-x-0 md:static md:w-[280px] md:sticky md:top-4 md:max-h-[calc(100vh-2rem)] md:shadow-none md:border-none md:overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']
      ...
      `}>
          ...
          <div className="p-6 md:p-0 md:pr-4 flex flex-col min-h-full">
              
              {/* Profile */}
              <div className="flex flex-col items-center text-center mt-2 mb-6 shrink-0">
              ...
              <div className={`h-px w-full mb-4 shrink-0 transition-colors duration-500 ${isDark ? 'bg-[#27272a]' : 'bg-gray-200'}`}></div>
                  ...
                  return (
                    ...
                    >
                        <div className="flex items-center gap-3">
                            <svg className={`w-5 h-5 shrink-0 transition-transform duration-300 ease-in-out group-hover:-rotate-12 ${active ? (isDark ? 'text-white' : 'text-gray-900') : (isDark ? 'text-[#71717a] group-hover:text-white' : 'text-[#71717a] group-hover:text-gray-900')}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d={item.iconPath}></path></svg>
                            <span className="text-sm font-medium">{item.label}</span>
                        </div>
                        {active && (
                             <svg className={`w-4 h-4 shrink-0 transition-colors duration-500 ${isDark ? 'text-[#52525b]' : 'text-gray-500'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                        )}
                    </Link>
                  );
                })}
              ...
              {/* Bottom Actions */}
              <div className="mt-6 shrink-0 pb-4 md:pb-0">
                  <button className={`w-full py-3 border font-bold text-sm rounded-full flex items-center justify-center gap-2 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg
                    ...
                    <svg className="w-5 h-5 shrink-0 transition-transform duration-300 group-hover:-rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path></svg>
                    Smart Talk
                  </button>
